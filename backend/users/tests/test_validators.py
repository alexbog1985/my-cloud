...
class ValidatorsTest(BaseTestCase):
    ...
    def test_validate_username_valid(self):
        ...
        for username in valid_usernames:
            try:
                ...
                self.fail(
                    f"validate_username() raised ValidationError unexpectedly for '{username}'"
                )
    ...
    def test_validate_username_minimum_length(self):
        ...
        try:
            ...
            self.fail(
                "validate_username() raised ValidationError unexpectedly for 4-character username"
            )
    ...
    def test_validate_username_maximum_length(self):
        ...
        try:
            ...
            self.fail(
                "validate_username() raised ValidationError unexpectedly for 20-character username"
            )
